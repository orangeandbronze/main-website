...
<div id="serviceContent3" class="section-content">
  ...
  <div class="buttons section-title">
    <a href="/works/providing-integrated-communication/" class="btn -primary">Providing integrated communication and collaboration tools to an IT / BPO company</a>
    <a href="/works/reducing-capex/" class="btn -primary">Reducing CAPEX through a cloud solution for an accounting firm</a>
  </div>
</div>
