...
This is the first in a series of twelve myths of Agile that I will be discussing, based on [my presentation](https://www.slideshare.net/CalenLegaspi1/agile-myths-and-misconceptions-36398946){:target="_blank"} at SofTech 2014 software engineering conference. Hang on for my next blog post, where I will discuss [Agile Myth #2: "Agile is Just About Project Management"](/blogs/2021/06/agile-myth2-agile-is-just-about-project-management).
