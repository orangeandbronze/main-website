...
<main>
      <section class="section-about">
        <div class="container panel-bg">
          <div class="row">
            <div class="col">
                <img src="/assets/images/Blog1-PagePhoto.png" class="img-fluid" alt="Developers coding on laptop">
                <h4 style="margin-top:50px;">ARTICLE 1 TITLE: Lorem ipsum dolor sit amet, consectetur adipiscing elit</h4>
                <h6>Posted | 22 JAN 2021 by LORENZO DEE</h6>
