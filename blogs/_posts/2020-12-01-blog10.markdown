...
<main>
      <section class="section-about">
        <div class="container panel-bg">
          <div class="row">
            <div class="col">
                <img src="/assets/images/Blog10-PagePhoto.png" class="img-fluid" alt="Developers coding on laptop">
                <h4 style="margin-top:50px;">ARTICLE 10 TITLE : Software Development Philippines</h4>
...
<p>We think, therefore we exist.</p>
          ...
          <div class="row pb-0">
            <div class="col-6 feedback-controls">
              <a class="btn-links" style="text-decoration: none" href="/blogs"><img class="prev" src="/assets/images/btn-prev.svg" alt="newer post" /> Back to Post List</a>
            </div>
          </div>
